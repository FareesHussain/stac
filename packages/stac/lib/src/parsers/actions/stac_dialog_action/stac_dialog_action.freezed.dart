...
/// Adds pattern-matching-related methods to [StacDialogAction].
extension StacDialogActionPatterns on StacDialogAction {
  ...
  TResult maybeMap<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacDialogAction() when $default != null:
    ...
    switch (_that) {
      case _StacDialogAction() when $default != null:
        return $default(
            ...
            _that.request,
            _that.assetPath,
            _that.barrierDismissible,
            _that.barrierColor,
            _that.barrierLabel,
            _that.useSafeArea,
            _that.traversalEdgeBehavior);
      case _:
        return orElse();
    }
  }
