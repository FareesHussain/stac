...
/// Adds pattern-matching-related methods to [StacPlaceholder].
extension StacPlaceholderPatterns on StacPlaceholder {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_StacPlaceholder value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StacPlaceholder() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(StacDouble fallbackWidth, StacDouble fallbackHeight,
            StacDouble strokeWidth, String color, Map<String, dynamic>? child)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StacPlaceholder() when $default != null:
        return $default(_that.fallbackWidth, _that.fallbackHeight,
            _that.strokeWidth, _that.color, _that.child);
      case _:
        return orElse();
    }
  }
