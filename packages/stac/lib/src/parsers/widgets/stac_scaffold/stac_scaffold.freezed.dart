...
/// Adds pattern-matching-related methods to [StacScaffold].
extension StacScaffoldPatterns on StacScaffold {
  ...
  TResult maybeMap<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacScaffold() when $default != null:
    ...
    switch (_that) {
      case _StacScaffold() when $default != null:
        return $default(
            _that.appBar,
            _that.body,
            _that.floatingActionButton,
            _that.floatingActionButtonLocation,
            _that.persistentFooterButtons,
            _that.drawer,
            _that.endDrawer,
            _that.bottomNavigationBar,
            _that.bottomSheet,
            _that.backgroundColor,
            _that.resizeToAvoidBottomInset,
            _that.primary,
            _that.drawerDragStartBehavior,
            _that.extendBody,
            _that.extendBodyBehindAppBar,
            _that.drawerScrimColor,
            _that.drawerEdgeDragWidth,
            _that.drawerEnableOpenDragGesture,
            _that.endDrawerEnableOpenDragGesture,
            _that.restorationId);
      case _:
        return orElse();
    }
