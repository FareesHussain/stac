...
/// Adds pattern-matching-related methods to [StacSpacer].
extension StacSpacerPatterns on StacSpacer {
  ...
  TResult maybeMap<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacSpacer() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int flex)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StacSpacer() when $default != null:
        return $default(_that.flex);
      case _:
        return orElse();
    }
  }
