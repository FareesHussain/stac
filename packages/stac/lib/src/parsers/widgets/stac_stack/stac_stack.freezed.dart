...
/// Adds pattern-matching-related methods to [StacStack].
extension StacStackPatterns on StacStack {
  ...
  TResult maybeMap<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacStack() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _StacStack() when $default != null:
        return $default(_that.alignment, _that.clipBehavior, _that.fit,
            _that.textDirection, _that.children);
      case _:
        return orElse();
    }
  }
