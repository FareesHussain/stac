...
/// Adds pattern-matching-related methods to [StacEdgeInsets].
extension StacEdgeInsetsPatterns on StacEdgeInsets {
  ...
  TResult maybeMap<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacEdgeInsets() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(StacDouble? left, StacDouble? top, StacDouble? right,
            StacDouble? bottom)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _StacEdgeInsets() when $default != null:
        return $default(_that.left, _that.top, _that.right, _that.bottom);
      case _:
        return orElse();
    }
  }
