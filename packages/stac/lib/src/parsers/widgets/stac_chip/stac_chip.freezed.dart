...
/// Adds pattern-matching-related methods to [StacChip].
extension StacChipPatterns on StacChip {
  ...
  TResult maybeMap<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacChip() when $default != null:
    ...
    switch (_that) {
      case _StacChip() when $default != null:
        return $default(
            ...
            _that.deleteButtonTooltipMessage,
            _that.side,
            _that.shape,
            _that.clipBehavior,
            _that.autofocus,
