...
/// Adds pattern-matching-related methods to [StacExpanded].
extension StacExpandedPatterns on StacExpanded {
  ...
  TResult maybeMap<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacExpanded() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int flex, Map<String, dynamic>? child)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StacExpanded() when $default != null:
        return $default(_that.flex, _that.child);
      case _:
        return orElse();
    }
  }
