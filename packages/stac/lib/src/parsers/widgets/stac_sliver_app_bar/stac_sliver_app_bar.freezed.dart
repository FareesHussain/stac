...
class _StacSliverAppBar implements StacSliverAppBar {
  ...
  final Map<String, dynamic>? _flexibleSpace;
  @override
  Map<String, dynamic>? get flexibleSpace {
    final value = _flexibleSpace;
    if (value == null) return null;
    if (_flexibleSpace is EqualUnmodifiableMapView) return _flexibleSpace;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._flexibleSpace, _flexibleSpace) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(_flexibleSpace),
