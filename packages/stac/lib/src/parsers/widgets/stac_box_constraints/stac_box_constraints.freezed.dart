...
/// Adds pattern-matching-related methods to [StacBoxConstraints].
extension StacBoxConstraintsPatterns on StacBoxConstraints {
  ...
  TResult maybeMap<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacBoxConstraints() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(StacDouble minWidth, StacDouble maxWidth,
            StacDouble minHeight, StacDouble maxHeight)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StacBoxConstraints() when $default != null:
        return $default(
            _that.minWidth, _that.maxWidth, _that.minHeight, _that.maxHeight);
      case _:
        return orElse();
    }
  }
