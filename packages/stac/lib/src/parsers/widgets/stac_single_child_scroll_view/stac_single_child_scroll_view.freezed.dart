...
/// Adds pattern-matching-related methods to [StacSingleChildScrollView].
extension StacSingleChildScrollViewPatterns on StacSingleChildScrollView {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_StacSingleChildScrollView value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StacSingleChildScrollView() when $default != null:
  ...
  TResult map<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacSingleChildScrollView():
        return $default(_that);
      case _:
