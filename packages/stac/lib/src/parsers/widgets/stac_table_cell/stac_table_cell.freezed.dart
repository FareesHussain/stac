...
/// Adds pattern-matching-related methods to [StacTableCell].
extension StacTableCellPatterns on StacTableCell {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_StacTableCell value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StacTableCell() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(TableCellVerticalAlignment? verticalAlignment,
            Map<String, dynamic>? child)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _StacTableCell() when $default != null:
        return $default(_that.verticalAlignment, _that.child);
      case _:
        return orElse();
    }
  }
