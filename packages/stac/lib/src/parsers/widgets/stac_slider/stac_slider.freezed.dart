...
/// Adds pattern-matching-related methods to [StacSlider].
extension StacSliderPatterns on StacSlider {
  ...
  TResult maybeMap<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacSlider() when $default != null:
    ...
    switch (_that) {
      case _StacSlider() when $default != null:
        return $default(
            ...
            _that.activeColor,
            _that.inactiveColor,
            _that.secondaryActiveColor,
            _that.thumbColor,
            _that.overlayColor,
            _that.mouseCursor,
            _that.autofocus,
            _that.allowedInteraction);
      case _:
        return orElse();
    }
  }
