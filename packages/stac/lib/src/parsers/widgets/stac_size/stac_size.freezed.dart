...
/// Adds pattern-matching-related methods to [StacSize].
extension StacSizePatterns on StacSize {
  ...
  TResult maybeMap<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacSize() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(StacDouble width, StacDouble height)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
