...
/// Adds pattern-matching-related methods to [StacImageFilter].
extension StacImageFilterPatterns on StacImageFilter {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_StacImageFilter value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StacImageFilter() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _StacImageFilter() when $default != null:
        return $default(_that.type, _that.sigmaX, _that.sigmaY, _that.radiusX,
            _that.radiusY, _that.matrix, _that.inner, _that.outer);
      case _:
        return orElse();
    }
  }
