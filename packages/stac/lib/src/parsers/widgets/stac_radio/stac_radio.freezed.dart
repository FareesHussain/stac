...
/// Adds pattern-matching-related methods to [StacRadio].
extension StacRadioPatterns on StacRadio {
  ...
  TResult maybeMap<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _StacRadio() when $default != null:
    ...
    switch (_that) {
      case _StacRadio() when $default != null:
        return $default(
            ...
            _that.visualDensity,
            _that.autofocus,
            _that.useCheckmarkStyle,
            _that.useCupertinoCheckmarkStyle);
      case _:
        return orElse();
    }
  }
