...
class _StacGestureDetector implements StacGestureDetector {
  const _StacGestureDetector(
      ...
      : _child = child,
        ...
        _onSecondaryTapDown = onSecondaryTapDown,
        _onSecondaryTapUp = onSecondaryTapUp,
        _onSecondaryTapCancel = onSecondaryTapCancel,
        _onTertiaryTapDown = onTertiaryTapDown,
        _onTertiaryTapUp = onTertiaryTapUp,
        _onTertiaryTapCancel = onTertiaryTapCancel,
        _onDoubleTapDown = onDoubleTapDown,
        _onDoubleTap = onDoubleTap,
        _onDoubleTapCancel = onDoubleTapCancel,
        _onLongPressDown = onLongPressDown,
        _onLongPressCancel = onLongPressCancel,
        ...
        _onSecondaryLongPressDown = onSecondaryLongPressDown,
        _onSecondaryLongPressCancel = onSecondaryLongPressCancel,
        _onSecondaryLongPress = onSecondaryLongPress,
        _onSecondaryLongPressStart = onSecondaryLongPressStart,
        _onSecondaryLongPressMoveUpdate = onSecondaryLongPressMoveUpdate,
        _onSecondaryLongPressUp = onSecondaryLongPressUp,
        _onSecondaryLongPressEnd = onSecondaryLongPressEnd,
        _onTertiaryLongPressDown = onTertiaryLongPressDown,
        _onTertiaryLongPressCancel = onTertiaryLongPressCancel,
        _onTertiaryLongPress = onTertiaryLongPress,
        _onTertiaryLongPressStart = onTertiaryLongPressStart,
        _onTertiaryLongPressMoveUpdate = onTertiaryLongPressMoveUpdate,
        _onTertiaryLongPressUp = onTertiaryLongPressUp,
        _onTertiaryLongPressEnd = onTertiaryLongPressEnd,
        _onVerticalDragDown = onVerticalDragDown,
        _onVerticalDragStart = onVerticalDragStart,
        _onVerticalDragUpdate = onVerticalDragUpdate,
        _onVerticalDragEnd = onVerticalDragEnd,
        _onVerticalDragCancel = onVerticalDragCancel,
        _onHorizontalDragDown = onHorizontalDragDown,
        _onHorizontalDragStart = onHorizontalDragStart,
        _onHorizontalDragUpdate = onHorizontalDragUpdate,
        _onHorizontalDragEnd = onHorizontalDragEnd,
        _onHorizontalDragCancel = onHorizontalDragCancel,
  ...
  final Map<String, dynamic>? _onTapDown;
  @override
  Map<String, dynamic>? get onTapDown {
    final value = _onTapDown;
    if (value == null) return null;
    if (_onTapDown is EqualUnmodifiableMapView) return _onTapDown;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onTapUp;
  @override
  Map<String, dynamic>? get onTapUp {
    final value = _onTapUp;
    if (value == null) return null;
    if (_onTapUp is EqualUnmodifiableMapView) return _onTapUp;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }
  ...
  final Map<String, dynamic>? _onTapCancel;
  @override
  Map<String, dynamic>? get onTapCancel {
    final value = _onTapCancel;
    if (value == null) return null;
    if (_onTapCancel is EqualUnmodifiableMapView) return _onTapCancel;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onSecondaryTap;
  @override
  Map<String, dynamic>? get onSecondaryTap {
    final value = _onSecondaryTap;
    if (value == null) return null;
    if (_onSecondaryTap is EqualUnmodifiableMapView) return _onSecondaryTap;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onSecondaryTapDown;
  @override
  Map<String, dynamic>? get onSecondaryTapDown {
    final value = _onSecondaryTapDown;
    if (value == null) return null;
    if (_onSecondaryTapDown is EqualUnmodifiableMapView)
      return _onSecondaryTapDown;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onSecondaryTapUp;
  @override
  Map<String, dynamic>? get onSecondaryTapUp {
    final value = _onSecondaryTapUp;
    if (value == null) return null;
    if (_onSecondaryTapUp is EqualUnmodifiableMapView) return _onSecondaryTapUp;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onSecondaryTapCancel;
  @override
  Map<String, dynamic>? get onSecondaryTapCancel {
    final value = _onSecondaryTapCancel;
    if (value == null) return null;
    if (_onSecondaryTapCancel is EqualUnmodifiableMapView)
      return _onSecondaryTapCancel;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onTertiaryTapDown;
  @override
  Map<String, dynamic>? get onTertiaryTapDown {
    final value = _onTertiaryTapDown;
    if (value == null) return null;
    if (_onTertiaryTapDown is EqualUnmodifiableMapView)
      return _onTertiaryTapDown;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onTertiaryTapUp;
  @override
  Map<String, dynamic>? get onTertiaryTapUp {
    final value = _onTertiaryTapUp;
    if (value == null) return null;
    if (_onTertiaryTapUp is EqualUnmodifiableMapView) return _onTertiaryTapUp;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onTertiaryTapCancel;
  @override
  Map<String, dynamic>? get onTertiaryTapCancel {
    final value = _onTertiaryTapCancel;
    if (value == null) return null;
    if (_onTertiaryTapCancel is EqualUnmodifiableMapView)
      return _onTertiaryTapCancel;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onDoubleTapDown;
  @override
  Map<String, dynamic>? get onDoubleTapDown {
    final value = _onDoubleTapDown;
    if (value == null) return null;
    if (_onDoubleTapDown is EqualUnmodifiableMapView) return _onDoubleTapDown;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onDoubleTap;
  @override
  Map<String, dynamic>? get onDoubleTap {
    final value = _onDoubleTap;
    if (value == null) return null;
    if (_onDoubleTap is EqualUnmodifiableMapView) return _onDoubleTap;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onDoubleTapCancel;
  @override
  Map<String, dynamic>? get onDoubleTapCancel {
    final value = _onDoubleTapCancel;
    if (value == null) return null;
    if (_onDoubleTapCancel is EqualUnmodifiableMapView)
      return _onDoubleTapCancel;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onLongPressDown;
  @override
  Map<String, dynamic>? get onLongPressDown {
    final value = _onLongPressDown;
    if (value == null) return null;
    if (_onLongPressDown is EqualUnmodifiableMapView) return _onLongPressDown;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onLongPressCancel;
  @override
  Map<String, dynamic>? get onLongPressCancel {
    final value = _onLongPressCancel;
    if (value == null) return null;
    if (_onLongPressCancel is EqualUnmodifiableMapView)
      return _onLongPressCancel;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }
  ...
  final Map<String, dynamic>? _onLongPressStart;
  @override
  Map<String, dynamic>? get onLongPressStart {
    final value = _onLongPressStart;
    if (value == null) return null;
    if (_onLongPressStart is EqualUnmodifiableMapView) return _onLongPressStart;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onLongPressMoveUpdate;
  @override
  Map<String, dynamic>? get onLongPressMoveUpdate {
    final value = _onLongPressMoveUpdate;
    if (value == null) return null;
    if (_onLongPressMoveUpdate is EqualUnmodifiableMapView)
      return _onLongPressMoveUpdate;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onLongPressUp;
  @override
  Map<String, dynamic>? get onLongPressUp {
    final value = _onLongPressUp;
    if (value == null) return null;
    if (_onLongPressUp is EqualUnmodifiableMapView) return _onLongPressUp;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onLongPressEnd;
  @override
  Map<String, dynamic>? get onLongPressEnd {
    final value = _onLongPressEnd;
    if (value == null) return null;
    if (_onLongPressEnd is EqualUnmodifiableMapView) return _onLongPressEnd;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onSecondaryLongPressDown;
  @override
  Map<String, dynamic>? get onSecondaryLongPressDown {
    final value = _onSecondaryLongPressDown;
    if (value == null) return null;
    if (_onSecondaryLongPressDown is EqualUnmodifiableMapView)
      return _onSecondaryLongPressDown;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onSecondaryLongPressCancel;
  @override
  Map<String, dynamic>? get onSecondaryLongPressCancel {
    final value = _onSecondaryLongPressCancel;
    if (value == null) return null;
    if (_onSecondaryLongPressCancel is EqualUnmodifiableMapView)
      return _onSecondaryLongPressCancel;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onSecondaryLongPress;
  @override
  Map<String, dynamic>? get onSecondaryLongPress {
    final value = _onSecondaryLongPress;
    if (value == null) return null;
    if (_onSecondaryLongPress is EqualUnmodifiableMapView)
      return _onSecondaryLongPress;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onSecondaryLongPressStart;
  @override
  Map<String, dynamic>? get onSecondaryLongPressStart {
    final value = _onSecondaryLongPressStart;
    if (value == null) return null;
    if (_onSecondaryLongPressStart is EqualUnmodifiableMapView)
      return _onSecondaryLongPressStart;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onSecondaryLongPressMoveUpdate;
  @override
  Map<String, dynamic>? get onSecondaryLongPressMoveUpdate {
    final value = _onSecondaryLongPressMoveUpdate;
    if (value == null) return null;
    if (_onSecondaryLongPressMoveUpdate is EqualUnmodifiableMapView)
      return _onSecondaryLongPressMoveUpdate;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onSecondaryLongPressUp;
  @override
  Map<String, dynamic>? get onSecondaryLongPressUp {
    final value = _onSecondaryLongPressUp;
    if (value == null) return null;
    if (_onSecondaryLongPressUp is EqualUnmodifiableMapView)
      return _onSecondaryLongPressUp;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onSecondaryLongPressEnd;
  @override
  Map<String, dynamic>? get onSecondaryLongPressEnd {
    final value = _onSecondaryLongPressEnd;
    if (value == null) return null;
    if (_onSecondaryLongPressEnd is EqualUnmodifiableMapView)
      return _onSecondaryLongPressEnd;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onTertiaryLongPressDown;
  @override
  Map<String, dynamic>? get onTertiaryLongPressDown {
    final value = _onTertiaryLongPressDown;
    if (value == null) return null;
    if (_onTertiaryLongPressDown is EqualUnmodifiableMapView)
      return _onTertiaryLongPressDown;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onTertiaryLongPressCancel;
  @override
  Map<String, dynamic>? get onTertiaryLongPressCancel {
    final value = _onTertiaryLongPressCancel;
    if (value == null) return null;
    if (_onTertiaryLongPressCancel is EqualUnmodifiableMapView)
      return _onTertiaryLongPressCancel;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onTertiaryLongPress;
  @override
  Map<String, dynamic>? get onTertiaryLongPress {
    final value = _onTertiaryLongPress;
    if (value == null) return null;
    if (_onTertiaryLongPress is EqualUnmodifiableMapView)
      return _onTertiaryLongPress;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onTertiaryLongPressStart;
  @override
  Map<String, dynamic>? get onTertiaryLongPressStart {
    final value = _onTertiaryLongPressStart;
    if (value == null) return null;
    if (_onTertiaryLongPressStart is EqualUnmodifiableMapView)
      return _onTertiaryLongPressStart;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onTertiaryLongPressMoveUpdate;
  @override
  Map<String, dynamic>? get onTertiaryLongPressMoveUpdate {
    final value = _onTertiaryLongPressMoveUpdate;
    if (value == null) return null;
    if (_onTertiaryLongPressMoveUpdate is EqualUnmodifiableMapView)
      return _onTertiaryLongPressMoveUpdate;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onTertiaryLongPressUp;
  @override
  Map<String, dynamic>? get onTertiaryLongPressUp {
    final value = _onTertiaryLongPressUp;
    if (value == null) return null;
    if (_onTertiaryLongPressUp is EqualUnmodifiableMapView)
      return _onTertiaryLongPressUp;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onTertiaryLongPressEnd;
  @override
  Map<String, dynamic>? get onTertiaryLongPressEnd {
    final value = _onTertiaryLongPressEnd;
    if (value == null) return null;
    if (_onTertiaryLongPressEnd is EqualUnmodifiableMapView)
      return _onTertiaryLongPressEnd;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onVerticalDragDown;
  @override
  Map<String, dynamic>? get onVerticalDragDown {
    final value = _onVerticalDragDown;
    if (value == null) return null;
    if (_onVerticalDragDown is EqualUnmodifiableMapView)
      return _onVerticalDragDown;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onVerticalDragStart;
  @override
  Map<String, dynamic>? get onVerticalDragStart {
    final value = _onVerticalDragStart;
    if (value == null) return null;
    if (_onVerticalDragStart is EqualUnmodifiableMapView)
      return _onVerticalDragStart;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onVerticalDragUpdate;
  @override
  Map<String, dynamic>? get onVerticalDragUpdate {
    final value = _onVerticalDragUpdate;
    if (value == null) return null;
    if (_onVerticalDragUpdate is EqualUnmodifiableMapView)
      return _onVerticalDragUpdate;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onVerticalDragEnd;
  @override
  Map<String, dynamic>? get onVerticalDragEnd {
    final value = _onVerticalDragEnd;
    if (value == null) return null;
    if (_onVerticalDragEnd is EqualUnmodifiableMapView)
      return _onVerticalDragEnd;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onVerticalDragCancel;
  @override
  Map<String, dynamic>? get onVerticalDragCancel {
    final value = _onVerticalDragCancel;
    if (value == null) return null;
    if (_onVerticalDragCancel is EqualUnmodifiableMapView)
      return _onVerticalDragCancel;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onHorizontalDragDown;
  @override
  Map<String, dynamic>? get onHorizontalDragDown {
    final value = _onHorizontalDragDown;
    if (value == null) return null;
    if (_onHorizontalDragDown is EqualUnmodifiableMapView)
      return _onHorizontalDragDown;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onHorizontalDragStart;
  @override
  Map<String, dynamic>? get onHorizontalDragStart {
    final value = _onHorizontalDragStart;
    if (value == null) return null;
    if (_onHorizontalDragStart is EqualUnmodifiableMapView)
      return _onHorizontalDragStart;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onHorizontalDragUpdate;
  @override
  Map<String, dynamic>? get onHorizontalDragUpdate {
    final value = _onHorizontalDragUpdate;
    if (value == null) return null;
    if (_onHorizontalDragUpdate is EqualUnmodifiableMapView)
      return _onHorizontalDragUpdate;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onHorizontalDragEnd;
  @override
  Map<String, dynamic>? get onHorizontalDragEnd {
    final value = _onHorizontalDragEnd;
    if (value == null) return null;
    if (_onHorizontalDragEnd is EqualUnmodifiableMapView)
      return _onHorizontalDragEnd;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onHorizontalDragCancel;
  @override
  Map<String, dynamic>? get onHorizontalDragCancel {
    final value = _onHorizontalDragCancel;
    if (value == null) return null;
    if (_onHorizontalDragCancel is EqualUnmodifiableMapView)
      return _onHorizontalDragCancel;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onForcePressStart;
  @override
  Map<String, dynamic>? get onForcePressStart {
    final value = _onForcePressStart;
    if (value == null) return null;
    if (_onForcePressStart is EqualUnmodifiableMapView)
      return _onForcePressStart;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onForcePressPeak;
  @override
  Map<String, dynamic>? get onForcePressPeak {
    final value = _onForcePressPeak;
    if (value == null) return null;
    if (_onForcePressPeak is EqualUnmodifiableMapView) return _onForcePressPeak;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onForcePressUpdate;
  @override
  Map<String, dynamic>? get onForcePressUpdate {
    final value = _onForcePressUpdate;
    if (value == null) return null;
    if (_onForcePressUpdate is EqualUnmodifiableMapView)
      return _onForcePressUpdate;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }

  final Map<String, dynamic>? _onForcePressEnd;
  @override
  Map<String, dynamic>? get onForcePressEnd {
    final value = _onForcePressEnd;
    if (value == null) return null;
    if (_onForcePressEnd is EqualUnmodifiableMapView) return _onForcePressEnd;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(value);
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._onTapUp, _onTapUp) &&
            const DeepCollectionEquality().equals(other._onTap, _onTap) &&
            const DeepCollectionEquality()
                .equals(other._onTapCancel, _onTapCancel) &&
            const DeepCollectionEquality()
                .equals(other._onSecondaryTap, _onSecondaryTap) &&
            const DeepCollectionEquality()
                .equals(other._onSecondaryTapDown, _onSecondaryTapDown) &&
            const DeepCollectionEquality()
                .equals(other._onSecondaryTapUp, _onSecondaryTapUp) &&
            const DeepCollectionEquality()
                .equals(other._onSecondaryTapCancel, _onSecondaryTapCancel) &&
            const DeepCollectionEquality()
                .equals(other._onTertiaryTapDown, _onTertiaryTapDown) &&
            const DeepCollectionEquality()
                .equals(other._onTertiaryTapUp, _onTertiaryTapUp) &&
            const DeepCollectionEquality()
                .equals(other._onTertiaryTapCancel, _onTertiaryTapCancel) &&
            const DeepCollectionEquality()
                .equals(other._onDoubleTapDown, _onDoubleTapDown) &&
            const DeepCollectionEquality()
                .equals(other._onDoubleTap, _onDoubleTap) &&
            const DeepCollectionEquality()
                .equals(other._onDoubleTapCancel, _onDoubleTapCancel) &&
            const DeepCollectionEquality()
                .equals(other._onLongPressDown, _onLongPressDown) &&
            const DeepCollectionEquality()
                .equals(other._onLongPressCancel, _onLongPressCancel) &&
            const DeepCollectionEquality()
                .equals(other._onLongPress, _onLongPress) &&
            const DeepCollectionEquality()
                .equals(other._onLongPressStart, _onLongPressStart) &&
            const DeepCollectionEquality()
                .equals(other._onLongPressMoveUpdate, _onLongPressMoveUpdate) &&
            const DeepCollectionEquality()
                .equals(other._onLongPressUp, _onLongPressUp) &&
            const DeepCollectionEquality()
                .equals(other._onLongPressEnd, _onLongPressEnd) &&
            const DeepCollectionEquality().equals(
                other._onSecondaryLongPressDown, _onSecondaryLongPressDown) &&
            const DeepCollectionEquality().equals(
                other._onSecondaryLongPressCancel,
                _onSecondaryLongPressCancel) &&
            const DeepCollectionEquality()
                .equals(other._onSecondaryLongPress, _onSecondaryLongPress) &&
            const DeepCollectionEquality().equals(
                other._onSecondaryLongPressStart, _onSecondaryLongPressStart) &&
            const DeepCollectionEquality().equals(
                other._onSecondaryLongPressMoveUpdate,
                _onSecondaryLongPressMoveUpdate) &&
            const DeepCollectionEquality().equals(
                other._onSecondaryLongPressUp, _onSecondaryLongPressUp) &&
            const DeepCollectionEquality().equals(
                other._onSecondaryLongPressEnd, _onSecondaryLongPressEnd) &&
            const DeepCollectionEquality().equals(
                other._onTertiaryLongPressDown, _onTertiaryLongPressDown) &&
            const DeepCollectionEquality().equals(
                other._onTertiaryLongPressCancel, _onTertiaryLongPressCancel) &&
            const DeepCollectionEquality()
                .equals(other._onTertiaryLongPress, _onTertiaryLongPress) &&
            const DeepCollectionEquality().equals(
                other._onTertiaryLongPressStart, _onTertiaryLongPressStart) &&
            const DeepCollectionEquality().equals(
                other._onTertiaryLongPressMoveUpdate,
                _onTertiaryLongPressMoveUpdate) &&
            const DeepCollectionEquality()
                .equals(other._onTertiaryLongPressUp, _onTertiaryLongPressUp) &&
            const DeepCollectionEquality().equals(
                other._onTertiaryLongPressEnd, _onTertiaryLongPressEnd) &&
            const DeepCollectionEquality()
                .equals(other._onVerticalDragDown, _onVerticalDragDown) &&
            const DeepCollectionEquality()
                .equals(other._onVerticalDragStart, _onVerticalDragStart) &&
            const DeepCollectionEquality()
                .equals(other._onVerticalDragUpdate, _onVerticalDragUpdate) &&
            const DeepCollectionEquality()
                .equals(other._onVerticalDragEnd, _onVerticalDragEnd) &&
            const DeepCollectionEquality()
                .equals(other._onVerticalDragCancel, _onVerticalDragCancel) &&
            const DeepCollectionEquality().equals(other._onHorizontalDragDown, _onHorizontalDragDown) &&
            const DeepCollectionEquality().equals(other._onHorizontalDragStart, _onHorizontalDragStart) &&
            const DeepCollectionEquality().equals(other._onHorizontalDragUpdate, _onHorizontalDragUpdate) &&
            const DeepCollectionEquality().equals(other._onHorizontalDragEnd, _onHorizontalDragEnd) &&
            const DeepCollectionEquality().equals(other._onHorizontalDragCancel, _onHorizontalDragCancel) &&
            const DeepCollectionEquality().equals(other._onForcePressStart, _onForcePressStart) &&
            const DeepCollectionEquality().equals(other._onForcePressPeak, _onForcePressPeak) &&
            const DeepCollectionEquality().equals(other._onForcePressUpdate, _onForcePressUpdate) &&
            const DeepCollectionEquality().equals(other._onForcePressEnd, _onForcePressEnd) &&
            (identical(other.excludeFromSemantics, excludeFromSemantics) || other.excludeFromSemantics == excludeFromSemantics) &&
            (identical(other.dragStartBehavior, dragStartBehavior) || other.dragStartBehavior == dragStartBehavior));
  }
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(_onTapDown),
        const DeepCollectionEquality().hash(_onTapUp),
        const DeepCollectionEquality().hash(_onTap),
        const DeepCollectionEquality().hash(_onTapCancel),
        const DeepCollectionEquality().hash(_onSecondaryTap),
        const DeepCollectionEquality().hash(_onSecondaryTapDown),
        const DeepCollectionEquality().hash(_onSecondaryTapUp),
        const DeepCollectionEquality().hash(_onSecondaryTapCancel),
        const DeepCollectionEquality().hash(_onTertiaryTapDown),
        const DeepCollectionEquality().hash(_onTertiaryTapUp),
        const DeepCollectionEquality().hash(_onTertiaryTapCancel),
        const DeepCollectionEquality().hash(_onDoubleTapDown),
        const DeepCollectionEquality().hash(_onDoubleTap),
        const DeepCollectionEquality().hash(_onDoubleTapCancel),
        const DeepCollectionEquality().hash(_onLongPressDown),
        const DeepCollectionEquality().hash(_onLongPressCancel),
        const DeepCollectionEquality().hash(_onLongPress),
        const DeepCollectionEquality().hash(_onLongPressStart),
        const DeepCollectionEquality().hash(_onLongPressMoveUpdate),
        const DeepCollectionEquality().hash(_onLongPressUp),
        const DeepCollectionEquality().hash(_onLongPressEnd),
        const DeepCollectionEquality().hash(_onSecondaryLongPressDown),
        const DeepCollectionEquality().hash(_onSecondaryLongPressCancel),
        const DeepCollectionEquality().hash(_onSecondaryLongPress),
        const DeepCollectionEquality().hash(_onSecondaryLongPressStart),
        const DeepCollectionEquality().hash(_onSecondaryLongPressMoveUpdate),
        const DeepCollectionEquality().hash(_onSecondaryLongPressUp),
        const DeepCollectionEquality().hash(_onSecondaryLongPressEnd),
        const DeepCollectionEquality().hash(_onTertiaryLongPressDown),
        const DeepCollectionEquality().hash(_onTertiaryLongPressCancel),
        const DeepCollectionEquality().hash(_onTertiaryLongPress),
        const DeepCollectionEquality().hash(_onTertiaryLongPressStart),
        const DeepCollectionEquality().hash(_onTertiaryLongPressMoveUpdate),
        const DeepCollectionEquality().hash(_onTertiaryLongPressUp),
        const DeepCollectionEquality().hash(_onTertiaryLongPressEnd),
        const DeepCollectionEquality().hash(_onVerticalDragDown),
        const DeepCollectionEquality().hash(_onVerticalDragStart),
        const DeepCollectionEquality().hash(_onVerticalDragUpdate),
        const DeepCollectionEquality().hash(_onVerticalDragEnd),
        const DeepCollectionEquality().hash(_onVerticalDragCancel),
        const DeepCollectionEquality().hash(_onHorizontalDragDown),
        const DeepCollectionEquality().hash(_onHorizontalDragStart),
        const DeepCollectionEquality().hash(_onHorizontalDragUpdate),
        const DeepCollectionEquality().hash(_onHorizontalDragEnd),
        const DeepCollectionEquality().hash(_onHorizontalDragCancel),
        const DeepCollectionEquality().hash(_onForcePressStart),
        const DeepCollectionEquality().hash(_onForcePressPeak),
        const DeepCollectionEquality().hash(_onForcePressUpdate),
        const DeepCollectionEquality().hash(_onForcePressEnd),
        excludeFromSemantics,
        dragStartBehavior
      ]);
