...
/// Adds pattern-matching-related methods to [StacSetValue].
extension StacSetValuePatterns on StacSetValue {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_StacSetValue value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StacSetValue() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<Map<String, dynamic>> values, StacWidget? child)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StacSetValue() when $default != null:
        return $default(_that.values, _that.child);
      case _:
        return orElse();
    }
  }
