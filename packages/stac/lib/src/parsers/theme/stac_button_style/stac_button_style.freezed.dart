...
/// Adds pattern-matching-related methods to [StacButtonStyle].
extension StacButtonStylePatterns on StacButtonStyle {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_StacButtonStyle value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StacButtonStyle() when $default != null:
    ...
    switch (_that) {
      case _StacButtonStyle() when $default != null:
        return $default(
            ...
            _that.side,
            _that.shape,
            _that.enabledMouseCursor,
            _that.disabledMouseCursor,
            _that.visualDensity,
            _that.tapTargetSize,
